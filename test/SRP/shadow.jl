...
test_cases = [
    (r = -[1, 0, 0], s = [-1, 0, 0], expected = 0),  # Satellite is directly between the body and the sun
    (r = -[-1, 0, 0], s = [-1, 0, 0], expected = 1),  # Satellite is directly behind the body relative to the sun
    ...
    (r = -[1, 0, 0], s = [1, 0, 0], expected = 1), # Satellite in full sun-light
]
